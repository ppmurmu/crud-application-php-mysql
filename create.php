...
<div class="container" style="padding-top: 10px;">
    <h3>Create Blog</h3>
    <hr>
    <form method="post" name="createblog" action="<?php echo base_url().'index.php/user/create';?>">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label>Status</label>
                <select name="status" class="browser-default custom-select" value="<?php echo set_value('Status');?>">
                    <option value="" disabled selected>Choose your option</option>
